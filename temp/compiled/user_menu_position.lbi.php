<div class="mui-mbar-tabs">
	<div class="quick_link_mian" data-userid="<?php echo $this->_var['user_id']; ?>">
        <div class="quick_links_panel">
            <div id="quick_media" class="quick_media">
              <ul>
                <li>
                  <a class="facebook" href="http://facebook.com/giggleday" target="new"></a>
                </li>
                <li>
                  <a class="instagram" href="https://www.instagram.com/giggledayofficial/" target="new"></a>
                </li>
              </ul>
            </div>
