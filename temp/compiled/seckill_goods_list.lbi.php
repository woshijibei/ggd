...
<div class="seckill-channel" id="h-seckill">
	<div class="box-hd clearfix">
		...
		<div class="sk-time-cd">
			<div class="sk-cd-tit"><?php if ($this->_var['sec_begin_time']): ?>距开始<?php else: ?>This round ends in<?php endif; ?></div>
        ...
        <div class="sk-more"><a href="<?php echo $this->_var['url_seckill']; ?>" target="_blank"><?php echo $this->_var['lang']['flashsale_more']; ?></a> <i class="arrow"></i></div>
	</div>
...
?>
			<li class="opacity_img">
				...
				<div class="p-over">
					...
					<?php else: ?>
					<a href="<?php echo $this->_var['goods']['url']; ?>"  target="_blank">Buy Now</a>
					<?php endif; ?>
					<?php endif; ?>
					</div>
				</div>
