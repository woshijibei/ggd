...
?>
    <li>
        ...
        <div class="info">
            ...
            <div class="btn_hover"><a href="<?php echo $this->_var['goods']['url']; ?>">Buy Now</a></div>
        </div>
    </li>
<?php endforeach; else: ?>
	<?php if ($this->_var['attr']['itemsLayout'] == "row3"): ?>
    <li>
        ...
        <div class="info">
            ...
            <div class="btn_hover"><a href="">Buy Now</a></div>
        </div>
    </li>
    <li>
        <div class="img"><a href="" title=""><img src="images/default/gd_pic_02.jpg"></a></div>
...
<?php if ($this->_var['temp'] == 'navigator_home'): ?>
    <li><a href="<?php echo $this->_var['index_url']; ?>" class="curr">Home</a></li>
...
?>
    ...
    <div class="m-c-item m-c-i-<?php echo $this->_foreach['master']['iteration']; ?>" style="background:url(<?php if ($this->_var['attr']['homeAdvBg']): ?><?php echo $this->_var['attr']['homeAdvBg']; ?><?php else: ?>../data/gallery_album/visualDefault/homeIndex_003.jpg<?php endif; ?>) center center no-repeat;">
        <div class="m-c-main">
            ...
            <a href="<?php echo $this->_var['attr']['url']; ?>" class="m-c-btn" target="_blank">GO</a>
        </div>
...
<div class="floor-line-con floorFour <?php echo $this->_var['spec_attr']['typeColor']; ?>" data-idx="1" id="floor_module_<?php echo $this->_var['spec_attr']['floorMode']; ?>" ectype="floorItem">
    <div class="floor-hd" ectype="floorTit">
        ...
        <div class="hd-tags">
            <ul>
                <li class="first current" data-catGoods="<?php echo $this->_var['spec_attr']['top_goods']; ?>" ectype="floor_cat_content" data-flooreveval="0" data-visualhome="1" data-floornum="<?php if ($this->_var['spec_attr']['floorMode'] == 1): ?>8<?php elseif ($this->_var['spec_attr']['floorMode'] == 2 || $this->_var['spec_attr']['floorMode'] == 3): ?>10<?php else: ?>12<?php endif; ?>" data-id="<?php echo $this->_var['spec_attr']['cat_id']; ?>" data-floorcat="<?php if ($this->_var['spec_attr']['floorMode'] == 1): ?>2<?php else: ?>0<?php endif; ?>">NEW ARRIVAL</li>
                <?php if ($this->_var['spec_attr']['cateValue']): ?>
                <?php $_from = $this->_var['spec_attr']['cateValue']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'cat');$this->_foreach['name'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['name']['total'] > 0):
    foreach ($_from AS $this->_var['cat']):
...
<div class="floor-line-con floorSix <?php echo $this->_var['spec_attr']['typeColor']; ?>" data-idx="1" id="floor_module_<?php echo $this->_var['spec_attr']['floorMode']; ?>" ectype="floorItem">
    <div class="floor-hd" ectype="floorTit">
        ...
        <div class="hd-tags">
            <ul>
                <li class="first current"data-catGoods="<?php echo $this->_var['spec_attr']['top_goods']; ?>" <?php if ($this->_var['spec_attr']['floorMode'] > 2): ?> ectype="floor_cat_content" <?php endif; ?>data-flooreveval="0" data-visualhome="1" data-floornum="<?php if ($this->_var['spec_attr']['floorMode'] == 3): ?>6<?php elseif ($this->_var['spec_attr']['floorMode'] == 4): ?>8<?php else: ?>0<?php endif; ?>" data-id="<?php echo $this->_var['spec_attr']['cat_id']; ?>" data-floorcat="<?php if ($this->_var['spec_attr']['floorMode'] == 1): ?>2<?php else: ?>0<?php endif; ?>">NEW ARRIVAL</li>
                <?php if ($this->_var['spec_attr']['cateValue']): ?>
                <?php $_from = $this->_var['spec_attr']['cateValue']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'cat');$this->_foreach['name'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['name']['total'] > 0):
    foreach ($_from AS $this->_var['cat']):
...
?>
                        <li class="child-curr opacity_img">
                            ...
                            <a href="<?php echo $this->_var['list']['url']; ?>" target="_blank" class="fr-btn">Buy Now</a>
                        </li>
                        <?php endforeach; else: ?>
                        <!--<li class="child-curr opacity_img">
                            <div class="product">
                            ...
                            <a href="#" target="_blank" class="fr-btn">Buy Now</a>
                        </li>
                        <li class="child-curr opacity_img">
                            <div class="product">
                                <div class="p-img"><a href="#" target="_blank"><img src="../data/gallery_album/visualDefault/zhanwei.png"></a></div>
...
?>
            ...
            <div class="floor-nav">
                <ul>
                    <li class="current" data-catGoods="<?php echo $this->_var['spec_attr']['top_goods']; ?>" ectype="floor_cat_content" data-flooreveval="0" data-visualhome="1" data-floornum="10" data-id="<?php echo $this->_var['spec_attr']['cat_id']; ?>" data-floorcat="2">NEW ARRIVAL<i></i></li>
                    <?php if ($this->_var['spec_attr']['cateValue']): ?>
                    <?php $_from = $this->_var['spec_attr']['cateValue']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'cat');$this->_foreach['name'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['name']['total'] > 0):
    foreach ($_from AS $this->_var['cat']):
