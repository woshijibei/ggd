                ...
                <div class="table_list" ectype='pic_list'>
                    <div class="gallery_album" data-act="get_albun_pic" data-inid="pic_list" data-url='get_ajax_content.php' data-where="sort_name=<?php echo $this->_var['filter']['sort_name']; ?>&album_id=<?php echo $this->_var['filter']['album_id']; ?>">
                        <ul class="ga-images-ul">
                            <?php $_from = $this->_var['pic_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'pic_list_0_68970800_1514810865');if (count($_from)):
    foreach ($_from AS $this->_var['pic_list_0_68970800_1514810865']):
?>
                            <li><a href="javascript:;" onclick="addpic('<?php echo $this->_var['pic_list_0_68970800_1514810865']['pic_file']; ?>',this)"><img src="<?php echo $this->_var['pic_list_0_68970800_1514810865']['pic_file']; ?>"><span class="pixel"><?php echo $this->_var['pic_list_0_68970800_1514810865']['pic_spec']; ?></span></a></li>
                            <?php endforeach; else: ?>
    ...
    <div class="body_info floor_info" style="display:none;">
        <div class="control_list">
            ...
            <div class="control_item">
                ...
                <div class="control_value"><input type="text" value="<?php echo $this->_var['lift']; ?>" class="text" name="lift" autocomplete="off" placeholder="请填写电梯层标题" ectype="required" data-msg="请在显示设置填写电梯层标题" /><div class="notic">模块名称是显示首页左侧浮动导航；只能2-4个字符，如：店铺、家用电器</div></div>
            </div>
            <?php endif; ?>
        </div>    
    </div>
...
<script language="JavaScript">
    ...
    function ajaxchangedgoods(type){
        ...
        var ru_id  = $("*[ectype='dialogRuId']").val();
		...
		function ajax(){
			Ajax.call('get_ajax_content.php?is_ajax=1&act=changedgoods', "cat_id="+cat_id+"&keyword="+keyword+"&goods_ids="+goods_ids+"&type="+type + "&resetRrl=1&search_type=" + search_type + "&goods_id=" + goods_id + "&ru_id="+ru_id, function(data){
...
<div class="control_list">
	<div class="control_item">
        <div class="control_text"><em class="red">*</em>模块名称：</div>
        <div class="control_value"><input type="text" value="<?php echo $this->_var['lift']; ?>" class="text" name="lift" autocomplete="off" placeholder="请填写电梯层标题" ectype="required" data-msg="请填写电梯层标题" /><div class="notic">模块名称是显示首页左侧浮动导航；只能2-4个字符，如：店铺、家用电器</div></div>
    </div> 
    <?php if ($this->_var['temp'] == 'h-master' || $this->_var['temp'] == 'h-storeRec'): ?>
    <div class="control_item">
        <div class="control_text">广告标题：</div>
        <div class="control_value"><input type="text" value="<?php echo $this->_var['masterTitle']; ?>" class="text" name="masterTitle" placeholder="广告标题" autocomplete="off"/></div>
    </div>   
    <?php endif; ?>
    <?php if ($this->_var['temp'] == 'h-need'): ?>
    <div class="control_item">
...
?>
                <div class="item">
                    <div class="title">My Panel<?php echo $this->_var['quick']['zh_cn']; ?></div>
                    <div class="content">
        ...
        <div class="body_info floor_info" style="display:none;">
            <div class="control_list">
                ...
                <div class="tit_head mb10">
                    <div class="control_item">
                        <div class="control_text"><em class="red">*</em>模块名称：</div>
                        <div class="control_value"><input name="lift" type="text" class="text text2" size="25" value="<?php echo $this->_var['lift']; ?>" placeholder="请填写电梯层标题" ectype="required" data-msg="请在显示设置填写电梯层标题"><div class="notic">模块名称是显示首页左侧浮动导航；只能2-4个字符，如：店铺、家用电器</div></div>
                    </div>
                </div>
                <?php endif; ?>
            </div>    
...
?>
        ...
        <div class="addCatagory" ectype="addCatagory">
            <input type="text" name="custom_catagory" class="text"/>
            <a href="javascript:void(0);" class="btn" ectype="topic_btn">添加新分类</a>
        </div>
    </div>
    <div class="body_info" style="display:none;">
    	<div class="control_list">
