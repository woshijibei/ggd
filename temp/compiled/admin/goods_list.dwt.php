                    	...
                    	<table cellpadding="0" cellspacing="0" border="0">
                        	<thead>
                            	<tr>
                                    ...
                                    <th width="19%"><div class="tDiv"><a href="javascript:listTable.sort('goods_name');"><?php echo $this->_var['lang']['goods_name']; ?></a><?php echo $this->_var['sort_goods_name']; ?></div></th>
									...
									<th width="3%"><div class="tDiv">真实销量</div></th>
									<th width="3%"><div class="tDiv">虚拟销量</div></th>
                            	...
                            	<tr>
                                    ...
                                    <td>
                                        <div class="tDiv">
                                        	...
                                        	<input class="text w10 tc fn" style="margin-right:0px;" onblur="listTable.editInput(this, 'edit_commission_rate', '<?php echo $this->_var['goods']['goods_id']; ?>' );" autocomplete="off" value="<?php echo empty($this->_var['goods']['commission_rate']) ? '0' : $this->_var['goods']['commission_rate']; ?>" type="text" <?php if (! $this->_var['goods']['user_id']): ?>disabled<?php endif; ?>>&nbsp;%
                                            <?php else: ?>
