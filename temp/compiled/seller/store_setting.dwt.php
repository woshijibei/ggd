            ...
            <div class="main-content" id="mainContent">
				...
				<div class="tabmenu">
					<ul class="tab" ectype="set_tab">
                        ...
                        <li data-type="contact"><a href="javascript:;">联系我们</a></li>
                            ...
                            <dd>
                                <div class="checkbox_items">
                                	<div class="checkbox_item">
                                        ...
                                        <label class="ui-radio-label" for="print_type_0">系统默认</label>
                                    </div>
                                    <div class="checkbox_item">
                                        ...
                                        <label class="ui-radio-label" for="print_type_1">快递鸟</label>
                                    </div>
                                </div>
                            </dd>
                        </dl>						
