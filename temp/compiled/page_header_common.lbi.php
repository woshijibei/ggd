...
<div class="header">
    <div class="w w1200">
        ...
        <div class="dsc-search">
            <div class="form">
                <form id="searchForm" name="searchForm" method="get" action="<?php echo $this->_var['site_domain']; ?>search.php" onSubmit="return checkSearchForm()" class="search-form">
...
?><?php endif; ?>" class="search-text"/>
                    ...
                    <button type="submit" class="button button-goods" onclick="checkstore_search_cmt(0)" ><?php echo $this->_var['lang']['search']; ?></button>
...
<?php if (! ( $this->_var['filename'] == 'merchants_store' || $this->_var['snapshot'] )): ?>
