...
/* list */
$_LANG['wholesale_cat'] = '批发分类';
$_LANG['wholesale_cat_list'] = '批发分类列表';
$_LANG['add_wholesale_cat'] = '添加批发分类';
$_LANG['edit_wholesale_cat'] = '编辑批发分类';
...
$_LANG['catadd_succed'] = '批发分类添加成功!';
$_LANG['catedit_succed'] = '批发分类编辑成功!';
$_LANG['is_show'] = '是否显示';
