...
*/
$_LANG['illegal_operate'] = "Illegal Operation";
...
/* 用户菜单 */
$_LANG['label_welcome'] = "My Homepage";
$_LANG['label_profile'] = 'Profile';
$_LANG['label_order'] = 'My Orders';
$_LANG['label_address'] = 'Addresses';
...
$_LANG['detailed_address'] = 'Street address';
...
$_LANG['add_address'] = 'Add Addresses';
...
/* 会员订单 */
$_LANG['order_list_lnk'] = 'My Orders';
...
/* 取回密码 */
$_LANG['back_home_lnk'] = 'Back to home';
...
/* 登录 注册 */
$_LANG['label_username'] = 'Username/Email/Mobile';
...
$_LANG['other_mobile_phone'] = 'Mobile';
$_LANG['remember'] = 'Rember me.';

$_LANG['msg_un_blank'] = 'Please enter the username.';
$_LANG['msg_un_length'] = '用户名最长不得超过15个字符，一个汉字等于2个字符';
$_LANG['msg_un_format'] = 'Invalid username.';
...
$_LANG['msg_confirm_pwd_blank'] = 'Password entered is different.';
...
$_LANG['login_failure'] = 'Your account or password is incorrect.';
...
$_LANG['passport_js']['username_empty'] = '<i></i>Please enter username.';
$_LANG['passport_js']['username_shorter'] = '<i></i>Atleast 4 characters.';
$_LANG['passport_js']['username_invalid'] = '<i></i>用户名只能是由字母数字以及下划线组成。';
$_LANG['passport_js']['password_empty'] = '<i></i>Please enter the password.';
$_LANG['passport_js']['password_shorter'] = '<i></i>Password must be at least 6 characters long.';
$_LANG['passport_js']['confirm_password_invalid'] = '<i></i>Password entered is different.';
$_LANG['passport_js']['captcha_empty'] = '<i></i>Please enter the code.';
...
$_LANG['passport_js']['msg_un_blank'] = '<i></i>Please enter the username.';
$_LANG['passport_js']['msg_un_length'] = '<i></i>用户名最长不得超过15个字符，一个汉字等于2个字符';
$_LANG['passport_js']['msg_un_format'] = '<i></i>Invalid username.';
...
$_LANG['passport_js']['msg_confirm_pwd_blank'] = '<i></i>Password entered is different.';
...
/* 用户菜单 */
$_LANG['order_list'] = 'My Orders';
$_LANG['address_list'] = 'Addresses';
...
$_LANG['captcha_empty'] = 'Please enter the code.';
...
$_LANG['bind_password2'] = "Repassword";
$_LANG['bind_password2_one'] = "请再次输入密码";
$_LANG['bind_phone'] = "Mobile";
...
$_LANG['agreed_bind'] = "By creating an account, you agree to ";
...
$_LANG['newtomc'] = "New to Giggleday?  ";
$_LANG['Free_registration'] = "Sign Up";
$_LANG['Welcome_login'] = "欢迎登录";
$_LANG['passport_one'] = "账户名与密码不匹配，请重新输入";
$_LANG['passportforgot_password'] = 'Forgot your password?';
$_LANG['signin_now'] = 'Sign in';
...
$_LANG['Have_account'] = "Already have an account?";
$_LANG['login_here'] = 'Sign in';
$_LANG['or_login'] = 'or ';
$_LANG['email_yanzheng'] = "Email";
$_LANG['email_label'] = "Email";
$_LANG['phone_yanzheng'] = "Mobile";
...
$_LANG['label_mobile_input'] = 'Please input mobile number.';
...
$_LANG['js_languages']['registered'] = "Sign in";
...
$_LANG['drop_pic'] = '删除图片';
$_LANG['Personal_homepage'] = "Homepage";
$_LANG['oreder_core'] = "My Orders";
$_LANG['user_core'] = "Account";
