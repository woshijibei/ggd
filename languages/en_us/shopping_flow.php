...
$_LANG['flow_surplus_pay'] = "购物流程正常余额支付下单";

$_LANG['bt_noll_impower'] = "对不起,您未被授权使用白条支付!";
$_LANG['bt_noll_balance'] = "对不起,您的白条额度已不足!";
$_LANG['bt_go_refund'] = "去还款";
$_LANG['bt_forbid_pay'] = "您有过期未付清的分期款额,您已被禁止下单,请先还款!";
...
$_LANG['invalid_value_card'] = "您选择的储值卡不存在。";
...
$_LANG['flow_js']['tele_not_null'] = '手机或电话不能为空！';
