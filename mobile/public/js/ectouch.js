...
$(function ($) {
    ...
    $(".j-search-check").click(function () {
        if ($(this).attr("data") == 1) {
            ...
            $(this).attr("data", 1).find("span").html("Shop");
    ...
    $(".j-filter-reset").click(function () {
        ...
        $(".j-filter-city span.text-all-span").text("Select");
...
function getAddress() {
    function checkPageSelectAddress(checkPage, addressPage, selectAddressBtn, addressText, fnc, urlFileName, addressFrom) {
        ...
        var urlFileName = urlFileName || ['parent_id=', 'parent_id=', 'parent_id=', 'parent_id=', 'parent_id='];
