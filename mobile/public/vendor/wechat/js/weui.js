...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * ```html
	 * <input type="radio" value="male" name="sex" required tips="Select性别" />
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * @param {function=} options.onConfirm 在点击"Confirm"之后的回调。回调返回选中的结果(Array)，数组长度依赖于picker的层级。
	 *
	 * @example
	 * // 单列picker
	 * weui.picker([
...
/***/ function(module, exports) {
	...
	module.exports = "<div> <div class=weui-mask></div> <div class=weui-picker> <div class=weui-picker__hd> <a href=javascript:; data-action=cancel class=weui-picker__action>{$lang.cancel}</a> <a href=javascript:; data-action=select class=weui-picker__action id=weui-picker-confirm>Confirm</a> </div> <div class=weui-picker__bd> </div> </div> </div>";
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 *     onDelete: function(){
	 *         if(confirm('确定删除该图片？')){ console.log('Delete'); }
	 *         gallery.hide();
	 *     }
	 * });
	 */
