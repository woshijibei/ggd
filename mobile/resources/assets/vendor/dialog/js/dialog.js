...
//			action = '<table class="ui-dialog-action"><tr>' + btnstr + '</tr></table>';
	...
	$.alert = function(content, button, callback, timer, settings) {
		...
		/*
		buttons :[{yes:"Confirm"},{no:'Cancel'},{close:'关闭'}]
		*/
	...
	var Dialog = function() {
		...
		this.id = 'dialog_' + rnd;
		this.settings = {};
		this.settings.closeTpl = $('<section class="goods-show-title  of-hidden padding-all b-color-f" style="border-bottom:1px solid #F6F6F9"><h3 class="fl g-c-title-h3">配送时间</h3><div class="fr filter-date-list"><a class="ui-confirm-no">{$lang.cancel}</a><a class=" ui-confirm-submit">Confirm</a></div></section>');
