...
class Index extends \App\Http\Base\Controllers\Frontend
{
	...
	public function actionIndex()
	{
		...
		$cart_goods = get_cart_goods('', 0, $this->region_id, $this->area_info['region_id'], $favourable_list);
		$cart_show = array();
		...
		$this->assign('page_title', 'Shopping Cart');
		$this->display();
	}
