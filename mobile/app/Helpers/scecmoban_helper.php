...
function get_merchants_goods_comment($ru_id)
{
	...
	if (4 <= $arr['cmt']['commentRank']['zconments']['score']) {
		$arr['cmt']['commentRank']['zconments']['goodReview'] = 'A';
	}
	else if (3 < $arr['cmt']['commentRank']['zconments']['score']) {
		$arr['cmt']['commentRank']['zconments']['goodReview'] = 'B';
	}
	else {
		$arr['cmt']['commentRank']['zconments']['goodReview'] = 'C';
	}

	if (4 <= $arr['cmt']['commentServer']['zconments']['score']) {
		$arr['cmt']['commentServer']['zconments']['goodReview'] = 'A';
	}
	else if (3 < $arr['cmt']['commentServer']['zconments']['score']) {
		$arr['cmt']['commentServer']['zconments']['goodReview'] = 'B';
	}
	else {
		$arr['cmt']['commentServer']['zconments']['goodReview'] = 'C';
	}

	if (4 <= $arr['cmt']['commentDelivery']['zconments']['score']) {
		$arr['cmt']['commentDelivery']['zconments']['goodReview'] = 'A';
	}
	else if (3 < $arr['cmt']['commentDelivery']['zconments']['score']) {
		$arr['cmt']['commentDelivery']['zconments']['goodReview'] = 'B';
	}
	else {
		$arr['cmt']['commentDelivery']['zconments']['goodReview'] = 'C';
	}
