...
class huitong
{
	...
	{
		$str = '<form style="margin:0px" methods="post" ' . 'action="http://www.htky365.com/Bill/Track" name="queryForm_' . $invoice_sn . '" target="_blank">' . '<input type="hidden" name="code" value="' . $invoice_sn . '" />' . '<a href="javascript:document.forms[\'queryForm_' . $invoice_sn . '\'].submit();">' . $invoice_sn . '</a>' . '</form>';
		return $str;
	}
}
