...
class yunda
{
	...
	{
		$str = '<form style="margin:0px" methods="post" ' . 'action="http://ykjcx.yundasys.com/go.php" name="queryForm_' . $invoice_sn . '" target="_blank">' . '<input type="hidden" name="wen" value="' . $invoice_sn . '" />' . '<a href="javascript:document.forms[\'queryForm_' . $invoice_sn . '\'].submit();">' . $invoice_sn . '</a>' . '</form>';
		return $str;
	}
}
