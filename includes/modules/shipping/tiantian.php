...
class tiantian
{
	...
	{
		$str = '<form style="margin:0px" methods="post" ' . 'action="http://www.ttkdex.com/ttkdweb/query.jsp" name="queryForm_' . $invoice_sn . '" target="_blank">' . '<input type="hidden" name="wen_no" value="' . $invoice_sn . '" />' . '<a href="javascript:document.forms[\'queryForm_' . $invoice_sn . '\'].submit();">' . $invoice_sn . '</a>' . '</form>';
		return $str;
	}
}
