...
class zjs
{
	...
	{
		$str = '<form style="margin:0px" methods="post" ' . 'action="http://www.zjs.com.cn/api/tracking.jspx" name="queryForm_' . $invoice_sn . '" target="_blank">' . '<input type="hidden" name="orderNos" value="' . $invoice_sn . '" />' . '<a href="javascript:document.forms[\'queryForm_' . $invoice_sn . '\'].submit();">' . $invoice_sn . '</a>' . '</form>';
		return $str;
	}
}
