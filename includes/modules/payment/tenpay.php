...
class tenpay
{
    ...
    function get_code($order, $payment)
    {
        ...
        $button  = '<form style="text-align:center;" action="https://www.tenpay.com/cgi-bin/v1.0/pay_gate.cgi" target="_blank" style="margin:0px;padding:0px" >';
...
//        $button  .= '<input type="image" src="'. $GLOBALS['ecs']->url() .'images/tenpay.gif" value="' .$GLOBALS['_LANG']['pay_button']. '" /></form>';
        //去掉财付通那个按钮的背景图片 bylu;
        $button  .= '<input type="submit" value="' .$GLOBALS['_LANG']['pay_button']. '" /></form>';
