				...
				if ($type == 1) {
					...
					if (strpos($lower_row, '</script>') !== false) {
						...
						if ((strpos($lower_row, 'updatexml') !== false) || (strpos($lower_row, 'extractvalue') !== false) || (strpos($lower_row, 'floor') !== false)) {
							...
							if (((strpos($lower_row, 'or') !== false) || (strpos($lower_row, 'hex') !== false) || (strpos($lower_row, 'unhex') !== false) || (strpos($lower_row, 'chr') !== false)) && !in_array($lower_row, $str_arr)) {
								$row = '';
							}
						}
					}
...
define('VERSION', 'v2.3.8');
define('RELEASE', '201701026');
?>