	...
	if (($_REQUEST['act'] == 'add') || ($_REQUEST['act'] == 'edit')) {
		...
		if (($_REQUEST['act'] == 'insert') || ($_REQUEST['act'] == 'update')) {
			...
			if ($account['is_paid'] == 0) {
				...
				$smsParams = array('user_name' => $user_info['user_name'], 'user_money' => $user_surplus['user_money'] + $amount, 'op_time' => local_date('Y-m-d H:i:s', gmtime()), 'mobile_phone' => $user_info['mobile_phone'] ? $user_info['mobile_phone'] : '', 'add_time' => local_date('Y-m-d H:i:s', $account['add_time']), 'examine' => '通过', 'fmt_amount' => $amount);
