...
if ($_REQUEST['act'] == '') {
	...
	$sql = 'SELECT COUNT(*) FROM ' . $GLOBALS['ecs']->table('users_real') . 'AS ur ' . ' JOIN ' . $GLOBALS['ecs']->table('users') . ' AS u ON ur.user_id = u.user_id AND review_status = 0 AND user_type = 1';
